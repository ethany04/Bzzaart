  ...
  useEffect(() => {
    ...
    useEffect(() => {
        ...
        for (const [key, value] of Object.entries(result)) {
            value.img = '/Users/ethanyu/Documents/Bzzaart/FrontEnd/Bzzaart/assets/' + value.img
            value.pfp = '/Users/ethanyu/Documents/Bzzaart/FrontEnd/Bzzaart/assets/' + value.pfp
            postArr.push(value);
        }
        setArtworks(postArr);
        })
